...
public interface CheckedIntPredicate<EX extends Exception> {
	 ...
	 */
	default IntPredicate fallbackTo(IntPredicate other) {
	 ...
	 * result.
	 */
	default IntPredicate fallbackToOr(IntPredicate other) {
        Objects.requireNonNull(other);
	 ...
	 * result.
	 */
	default IntPredicate orReturn(boolean value) {
		return t -> {
			try {
				return test(t);
			} catch (Exception e) {
	 ...
	 */
	default IntPredicate rethrowUnchecked(Function<? super EX, ? extends RuntimeException> mapper) {
	 ...
	 */
	default <EX2 extends Exception> CheckedIntPredicate<EX2> rethrow(Function<? super EX, EX2> mapper) {
        Objects.requireNonNull(mapper);
	 ...
	 */
	default CheckedIntPredicate<EX> except(Consumer<? super EX> exceptionHandler) {	
	 ...
	 */
	default <EX2 extends EX> CheckedIntPredicate<EX> except(
	 ...
	 */
	default CheckedIntPredicate<EX> exceptUnchecked(
			Consumer<? super RuntimeException> exceptionHandler) {
		return exceptUnchecked(RuntimeException.class, exceptionHandler);
	}
	
	default <REX extends RuntimeException> CheckedIntPredicate<EX> exceptUnchecked(
	 ...
	 * exception handler. Afterwards, the exception is rethrown.
	 */
	default CheckedIntPredicate<EX> orTry(CheckedIntPredicate<? extends EX> other) {
        Objects.requireNonNull(other);
     ...
     */
    default CheckedIntPredicate<EX> and(CheckedIntPredicate<? extends EX> other) {
        Objects.requireNonNull(other);
     ...
     */
    default CheckedIntPredicate<EX> negate() {
        return t -> !test(t);
    }
	 ...
	 */
    default CheckedIntPredicate<EX> or(CheckedIntPredicate<? extends EX> other) {
        Objects.requireNonNull(other);
