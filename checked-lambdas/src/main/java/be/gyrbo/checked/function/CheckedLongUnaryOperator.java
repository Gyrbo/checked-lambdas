...
@FunctionalInterface
public interface CheckedLongUnaryOperator<EX extends Exception> {

	long applyOrThrow(long t) throws EX;
	 ...
	 */
	default LongUnaryOperator sneakyThrow() {
		return t -> {
			@SuppressWarnings("unchecked")
			CheckedLongUnaryOperator<RuntimeException> sneaky = (CheckedLongUnaryOperator<RuntimeException>) this;
			return sneaky.applyOrThrow(t);
		};
	}	
	
	@FunctionalInterface
	public interface Adapter<EX extends Exception> extends CheckedLongUnaryOperator<EX>, LongUnaryOperator {
		default long applyOrThrow(long t) throws EX {
	...
	public interface Helper<EX extends Exception> extends CheckedLongUnaryOperator<EX> {
	
		/**
		 * In case an exception occurs, an empty Optional is returned
		 */
		default LongFunction<OptionalLong> optional() {
			return t -> {
				try {
		 ...
		 */
		default CheckedLongUnaryOperator.Adapter<EX> fallbackTo(LongUnaryOperator other) {
		 ...
		 * result.
		 */
		default CheckedLongUnaryOperator.Adapter<EX> orReturn(long value) {
			return t -> {
				try {
					return applyOrThrow(t);
				} catch (Exception e) {
		 ...
		 */
		default CheckedLongUnaryOperator.Adapter<EX> orIdentity() {
			return t -> {
				try {
					return applyOrThrow(t);
				} catch (Exception e) {
		 ...
		 */
		default CheckedLongUnaryOperator.Adapter<EX> rethrowUnchecked(Function<? super EX, ? extends RuntimeException> mapper) {
		 ...
		 */
		default <EX2 extends Exception> CheckedLongUnaryOperator.Helper<EX2> rethrow(Function<? super EX, EX2> mapper) {
	        Objects.requireNonNull(mapper);
		 ...
		 */
		default CheckedLongUnaryOperator.Helper<EX> except(Consumer<? super EX> exceptionHandler) {	
		 ...
		 */
		default <EX2 extends EX> CheckedLongUnaryOperator.Helper<EX> except(
		 ...
		 */
		default CheckedLongUnaryOperator.Helper<EX> exceptUnchecked(
				Consumer<? super RuntimeException> exceptionHandler) {
			return exceptUnchecked(RuntimeException.class, exceptionHandler);
		}
		
		default <REX extends RuntimeException> CheckedLongUnaryOperator.Helper<EX> exceptUnchecked(
		 ...
		 * exception handler. Afterwards, the exception is rethrown.
		 */
		default CheckedLongUnaryOperator.Helper<EX> orTry(CheckedLongUnaryOperator<? extends EX> other) {
	        Objects.requireNonNull(other);
