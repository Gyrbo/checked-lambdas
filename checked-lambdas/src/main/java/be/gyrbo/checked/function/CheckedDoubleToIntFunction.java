...
public interface CheckedDoubleToIntFunction<EX extends Exception> {
	...
	int applyAsInt(double t) throws EX;
	 ...
	 */
	default DoubleToIntFunction fallbackTo(DoubleToIntFunction other) {
	 ...
	 */
	default DoubleToIntFunction rethrowUnchecked(Function<? super EX, ? extends RuntimeException> mapper) {
	 ...
	 */
	default <EX2 extends Exception> CheckedDoubleToIntFunction<EX2> rethrow(Function<? super EX, EX2> mapper) {
        Objects.requireNonNull(mapper);
	 ...
	 */
	default CheckedDoubleToIntFunction<EX> except(Consumer<? super EX> exceptionHandler) {	
	 ...
	 */
	default <EX2 extends EX> CheckedDoubleToIntFunction<EX> except(
	 ...
	 */
	default CheckedDoubleToIntFunction<EX> exceptUnchecked(
			Consumer<? super RuntimeException> exceptionHandler) {
		return exceptUnchecked(RuntimeException.class, exceptionHandler);
	}
	
	default <REX extends RuntimeException> CheckedDoubleToIntFunction<EX> exceptUnchecked(
	 ...
	 * exception handler. Afterwards, the exception is rethrown.
	 */
	default CheckedDoubleToIntFunction<EX> orTry(CheckedDoubleToIntFunction<? extends EX> other) {
        Objects.requireNonNull(other);
