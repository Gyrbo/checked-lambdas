...
@FunctionalInterface
public interface CheckedDoubleToIntFunction<EX extends Exception> {

	int applyOrThrow(double t) throws EX;
	 ...
	 */
	default DoubleToIntFunction sneakyThrow() {
		return t -> {
			@SuppressWarnings("unchecked")
			CheckedDoubleToIntFunction<RuntimeException> sneaky = (CheckedDoubleToIntFunction<RuntimeException>) this;
			return sneaky.applyOrThrow(t);
		};
	}	
	
	@FunctionalInterface
	public interface Adapter<EX extends Exception> extends CheckedDoubleToIntFunction<EX>, DoubleToIntFunction {
		default int applyOrThrow(double t) throws EX {
	...
	public interface Helper<EX extends Exception> extends CheckedDoubleToIntFunction<EX> {
	
		/**
		 * In case an exception occurs, an empty Optional is returned
		 */
		default DoubleFunction<OptionalInt> optional() {
			return t -> {
				try {
		 ...
		 */
		default CheckedDoubleToIntFunction.Adapter<EX> fallbackTo(DoubleToIntFunction other) {
		 ...
		 * result.
		 */
		default CheckedDoubleToIntFunction.Adapter<EX> orReturn(int value) {
			return t -> {
				try {
					return applyOrThrow(t);
				} catch (Exception e) {
		 ...
		 */
		default CheckedDoubleToIntFunction.Adapter<EX> rethrowUnchecked(Function<? super EX, ? extends RuntimeException> mapper) {
		 ...
		 */
		default <EX2 extends Exception> CheckedDoubleToIntFunction.Helper<EX2> rethrow(Function<? super EX, EX2> mapper) {
	        Objects.requireNonNull(mapper);
		 ...
		 */
		default CheckedDoubleToIntFunction.Helper<EX> except(Consumer<? super EX> exceptionHandler) {	
		 ...
		 */
		default <EX2 extends EX> CheckedDoubleToIntFunction.Helper<EX> except(
		 ...
		 */
		default CheckedDoubleToIntFunction.Helper<EX> exceptUnchecked(
				Consumer<? super RuntimeException> exceptionHandler) {
			return exceptUnchecked(RuntimeException.class, exceptionHandler);
		}
		
		default <REX extends RuntimeException> CheckedDoubleToIntFunction.Helper<EX> exceptUnchecked(
		 ...
		 * exception handler. Afterwards, the exception is rethrown.
		 */
		default CheckedDoubleToIntFunction.Helper<EX> orTry(CheckedDoubleToIntFunction<? extends EX> other) {
	        Objects.requireNonNull(other);
